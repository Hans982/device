...
git clone --depth=1 https://github.com/Hans982/device -b infinity device/asus/X00TD

rm -rf vendor/asus
git clone --depth=1 https://github.com/electrolaboratory/vendor_common -b los vendor/asus/sdm660-common
git clone --depth=1 https://github.com/Hans982/vendor_device -b v vendor/asus/X00TD
...
export KBUILD_BUILD_USER=hans982
